package org.tmx.common.oss.client;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.IdUtil;
import org.tmx.common.core.utils.DateUtils;
import org.tmx.common.core.utils.StringUtils;
import org.tmx.common.oss.config.OssClientConfig;
import org.tmx.common.oss.exception.S3StorageException;
import org.tmx.common.oss.io.OutputStreamDownloadSubscriber;
import org.tmx.common.oss.model.GetObjectResult;
import org.tmx.common.oss.model.HandleAsyncResult;
import org.tmx.common.oss.model.Options;
import org.tmx.common.oss.model.PutObjectResult;
...
public abstract class AbstractOssClientImpl implements OssClient {
    ...
    public PutObjectResult bucketUpload(String bucket, String key, InputStream in, long contentLength, Options options) {
        Path tempFile = null;
        try {
            tempFile = Files.createTempFile("tmx-oss-upload-", ".tmp");
