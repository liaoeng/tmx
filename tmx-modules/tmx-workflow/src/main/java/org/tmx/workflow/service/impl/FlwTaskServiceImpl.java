package org.tmx.workflow.service.impl;
...
import org.tmx.common.core.enums.BusinessStatusEnum;
...
import org.tmx.common.liteflow.utils.LiteFlowUtils;
import org.tmx.common.mybatis.core.page.PageQuery;
import org.tmx.common.mybatis.core.query.QueryBuilder;
import org.tmx.common.mybatis.utils.IdGeneratorUtil;
import org.tmx.common.satoken.utils.LoginHelper;
import org.tmx.system.api.UserService;
import org.tmx.system.api.domain.UserDTO;
...
import org.tmx.workflow.api.domain.StartProcessReturnDTO;
import org.tmx.workflow.common.ConditionalOnEnable;
import org.tmx.workflow.common.enums.TaskAssigneeType;
import org.tmx.workflow.common.enums.TaskStatusEnum;
import org.tmx.workflow.domain.bo.*;
...
import org.tmx.workflow.domain.vo.FlowCopyVo;
import org.tmx.workflow.domain.vo.FlowHisTaskVo;
import org.tmx.workflow.domain.vo.FlowTaskVo;
import org.tmx.workflow.domain.vo.NodeExtVo;
import org.tmx.workflow.mapper.FlwCategoryMapper;
import org.tmx.workflow.mapper.FlwHisTaskMapper;
import org.tmx.workflow.mapper.FlwTaskMapper;
import org.tmx.workflow.service.IFlwCommonService;
import org.tmx.workflow.service.IFlwNodeExtService;
import org.tmx.workflow.service.IFlwTaskAssigneeService;
import org.tmx.workflow.service.IFlwTaskService;
...
public class FlwTaskServiceImpl implements IFlwTaskService {
    ...
    public void setCopy(Task task, List<FlowCopyBo> flowCopyList) {
        ...
        flwCommonService.sendMessage(
            List.of(org.tmx.workflow.common.enums.MessageTypeEnum.SYSTEM_MESSAGE.getCode()),
            "您收到一条新的流程抄送，请及时查看。",
            "单据抄送提醒",
