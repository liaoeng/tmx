...
import org.tmx.common.core.enums.PushSourceEnum;
import org.tmx.common.core.enums.PushTypeEnum;
import org.tmx.common.core.utils.DateUtils;
...
import org.tmx.common.encrypt.annotation.ApiEncrypt;
import org.tmx.common.json.utils.JsonUtils;
import org.tmx.common.satoken.utils.LoginHelper;
import org.tmx.common.social.config.properties.SocialLoginConfigProperties;
import org.tmx.common.social.config.properties.SocialProperties;
import org.tmx.common.social.utils.SocialUtils;
import org.tmx.system.api.MessageService;
import org.tmx.system.api.domain.PushPayloadDTO;
import org.tmx.system.api.model.RegisterBody;
import org.tmx.system.api.model.SocialLoginBody;
import org.tmx.system.domain.vo.SysClientVo;
import org.tmx.system.service.ISysClientService;
import org.tmx.system.service.ISysConfigService;
import org.tmx.system.service.ISysSocialService;
import org.tmx.web.domain.vo.LoginVo;
import org.tmx.web.service.IAuthStrategy;
import org.tmx.web.service.SysLoginService;
import org.tmx.web.service.SysRegisterService;
        ...
        scheduledExecutorService.schedule(() -> {
            messageService.publishMessage(
                ...
                PushPayloadDTO.of(
                    ...
                    DateUtils.getTodayHour(new Date()) + "好，欢迎登录 tmx 后台管理系统",
                    null
                )
            );
        }, 5, TimeUnit.SECONDS);
